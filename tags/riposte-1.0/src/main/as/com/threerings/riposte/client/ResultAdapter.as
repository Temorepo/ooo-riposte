...
/**
 * ResultAdapter adapts functions to work as a PostResultListener.
 */
public class ResultAdapter extends PostAdapter
    implements PostResultListener
{
    ...
    // documentation inherited from interface PostResultListener
